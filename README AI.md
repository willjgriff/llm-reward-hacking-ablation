...
- Reward hacking may not be mediated by a single clean direction (see Key Open Questions).
...
- Project doc: [link](https://docs.google.com/document/d/1jdNhWacPyFmWbkDv_EPhm6EUnsgtRVCdDqkH3u3729c/edit?tab=t.0#heading=h.x6itok4jtf2p)
